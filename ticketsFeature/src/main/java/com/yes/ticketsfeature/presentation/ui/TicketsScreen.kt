...
class TicketsScreen : BaseFragment() {
    ...
    override fun setUpView() {
        ...
        val dateString= mapDateToString(date)
          ...
          (binding as TicketsBinding).route.text=arguments?.getString("departure")+"-"+arguments?.getString("arrival")
         (binding as TicketsBinding).info.text=dateString+", "+arguments?.getString("pass_count")+" пассажир"
